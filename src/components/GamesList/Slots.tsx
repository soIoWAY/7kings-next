...
const Slots = () => {
	return (
		<div className='flex flex-col gap-3' id='slots'>
			...
			<div className='flex flex-wrap gap-4'>
				<Link
					href='games/fruits'
					className={`bg-gradient-to-tr from-red-700 to-slate-900 w-[47%] sm:w-4/12 md:w-2/12 h-48 sm:h-64 flex flex-col gap-4 items-center justify-center rounded-md`}
				>
					<Image src='/cherry.svg' width={128} height={128} alt='Cherry' />
					<h2 className='text-white text-2xl font-semibold'>Fruits</h2>
				</Link>
				<div
					className={`bg-gradient-to-tr from-teal-600 to-stone-900 w-[47%] sm:w-4/12 md:w-2/12 h-48 sm:h-64 flex flex-col gap-4 items-center justify-center rounded-md`}
				>
